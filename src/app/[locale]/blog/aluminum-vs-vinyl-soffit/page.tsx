...
import { ArrowRight, CheckCircle2, XCircle, Phone } from "lucide-react";
...
export async function generateMetadata({
    ...
    const titles: Record<string, string> = {
        en: "Aluminum vs Vinyl Soffit: Complete 2026 Comparison for Florida Homes",
        es: "Soffit de Aluminio vs Vinilo: Comparación Completa 2026 para Casas en Florida",
        pt: "Soffit de Alumínio vs Vinil: Comparação Completa 2026 para Casas na Flórida",
    };
    const descriptions: Record<string, string> = {
        en: "Side-by-side comparison of aluminum and vinyl soffit for Florida's climate. Cost, lifespan, hurricane resistance, heat tolerance, and which one to choose.",
        es: "Comparación de soffit de aluminio y vinilo para el clima de Florida. Costo, vida útil, resistencia a huracanes, tolerancia al calor y cuál elegir.",
        pt: "Comparação entre soffit de alumínio e vinil para o clima da Flórida. Custo, vida útil, resistência a furacões, tolerância ao calor e qual escolher.",
    };
...
const content = {
    en: {
        breadcrumb: "Blog",
        category: "Materials",
        readTime: "8 min read · January 22, 2026",
        authorLine: <>By <span className="font-semibold text-gray-700">Eddy</span> · Soffit &amp; Fascia Specialist · <time dateTime="2026-01-22">January 22, 2026</time></>,
        h1a: "Aluminum vs Vinyl Soffit:",
        h1b: "Complete 2026 Comparison",
        intro: "The most common question homeowners ask us. Here's an honest side-by-side breakdown — cost, lifespan, hurricane resistance, and the final answer for Florida homes.",
        verdictTitle: "The Short Answer",
        verdictBody: <><strong>Aluminum is the better material for Florida homes</strong> in almost every category: fire resistance, hurricane rating, heat tolerance, pest resistance, and lifespan. Vinyl costs slightly less and offers more color options, but the premium for aluminum on a typical project is only $150–$400.</>,
        ...
        introP: "When we visit a home in Orlando, the most common question is: \"Should I go with aluminum or vinyl?\" There's no universal answer — it depends on your budget, home orientation, and how long you plan to stay in the house. Here's what each material actually does:",
        ...
        comparison: [
            { category: "Cost (installed)", aluminum: "Slightly higher", vinyl: "Slightly lower", winner: "vinyl" },
            { category: "Lifespan (Florida)", aluminum: "20–30 years", vinyl: "15–20 years", winner: "aluminum" },
            { category: "Hurricane resistance", aluminum: "Excellent — hurricane rated", vinyl: "Good — adequate for most storms", winner: "aluminum" },
            { category: "Heat tolerance", aluminum: "Does not warp", vinyl: "Can warp above 140°F", winner: "aluminum" },
            { category: "Fire resistance", aluminum: "Non-combustible", vinyl: "Will burn", winner: "aluminum" },
            { category: "Moisture resistance", aluminum: "100% — won't rot", vinyl: "100% — won't rot", winner: "tie" },
            { category: "Pest resistance", aluminum: "Hard to penetrate", vinyl: "Can be chewed through", winner: "aluminum" },
            { category: "Color options", aluminum: "10 colors available", vinyl: "Wider color variety", winner: "vinyl" },
            { category: "Maintenance", aluminum: "None required", vinyl: "Occasional cleaning", winner: "aluminum" },
            { category: "Environmental", aluminum: "100% recyclable", vinyl: "Not recyclable", winner: "aluminum" },
            { category: "Manufacturer warranty", aluminum: "Up to 30 years", vinyl: "10–15 years typical", winner: "aluminum" },
            { category: "Installation difficulty", aluminum: "Professional recommended", vinyl: "Professional recommended", winner: "tie" },
        ],
    },
    es: {
        breadcrumb: "Blog",
        category: "Materiales",
        readTime: "8 min de lectura · 22 de enero de 2026",
        authorLine: <>Por <span className="font-semibold text-gray-700">Eddy</span> · Especialista en Soffit y Fascia · <time dateTime="2026-01-22">22 de enero de 2026</time></>,
        h1a: "Soffit de Aluminio vs Vinilo:",
        h1b: "Comparación Completa 2026",
        intro: "La pregunta más común que nos hacen los propietarios. Aquí hay un análisis honesto: costo, vida útil, resistencia a huracanes y la respuesta definitiva para casas en Florida.",
        verdictTitle: "La Respuesta Corta",
        verdictBody: <><strong>El aluminio es el mejor material para casas en Florida</strong> en casi todas las categorías: resistencia al fuego, clasificación de huracanes, tolerancia al calor, resistencia a plagas y vida útil. El vinilo cuesta un poco menos y ofrece más opciones de color, pero la prima por aluminio en un proyecto típico es solo $150–$400.</>,
        ...
        introP: "Cuando visitamos una casa en Orlando, la pregunta más común es: \"¿Debo elegir aluminio o vinilo?\" No hay una respuesta universal: depende de su presupuesto, orientación de la casa y cuánto tiempo planea quedarse. Aquí está lo que cada material realmente hace:",
        ...
        comparison: [
            { category: "Costo (instalado)", aluminum: "Un poco más alto", vinyl: "Un poco más bajo", winner: "vinyl" },
            { category: "Vida útil (Florida)", aluminum: "20–30 años", vinyl: "15–20 años", winner: "aluminum" },
            { category: "Resistencia a huracanes", aluminum: "Excelente, clasificado para huracanes", vinyl: "Buena, adecuado para la mayoría de tormentas", winner: "aluminum" },
            { category: "Tolerancia al calor", aluminum: "No se deforma", vinyl: "Puede deformarse sobre 60°C", winner: "aluminum" },
            { category: "Resistencia al fuego", aluminum: "No combustible", vinyl: "Combustible", winner: "aluminum" },
            { category: "Resistencia a la humedad", aluminum: "100%, no se pudre", vinyl: "100%, no se pudre", winner: "tie" },
            { category: "Resistencia a plagas", aluminum: "Difícil de penetrar", vinyl: "Pueden roerlo", winner: "aluminum" },
            { category: "Opciones de color", aluminum: "10 colores disponibles", vinyl: "Mayor variedad de colores", winner: "vinyl" },
            { category: "Mantenimiento", aluminum: "No requiere mantenimiento", vinyl: "Limpieza ocasional", winner: "aluminum" },
            { category: "Medioambiental", aluminum: "100% reciclable", vinyl: "No reciclable", winner: "aluminum" },
            { category: "Garantía del fabricante", aluminum: "Hasta 30 años", vinyl: "10–15 años típico", winner: "aluminum" },
            { category: "Dificultad de instalación", aluminum: "Se recomienda profesional", vinyl: "Se recomienda profesional", winner: "tie" },
        ],
    },
    pt: {
        breadcrumb: "Blog",
        category: "Materiais",
        readTime: "8 min de leitura · 22 de janeiro de 2026",
        authorLine: <>Por <span className="font-semibold text-gray-700">Eddy</span> · Especialista em Soffit e Fascia · <time dateTime="2026-01-22">22 de janeiro de 2026</time></>,
        h1a: "Soffit de Alumínio vs Vinil:",
        h1b: "Comparação Completa 2026",
        intro: "A pergunta mais comum que os proprietários nos fazem. Aqui está uma análise honesta: custo, vida útil, resistência a furacões e a resposta definitiva para casas na Flórida.",
        verdictTitle: "A Resposta Curta",
        verdictBody: <><strong>O alumínio é o melhor material para casas na Flórida</strong> em quase todas as categorias: resistência ao fogo, classificação para furacões, tolerância ao calor, resistência a pragas e vida útil. O vinil custa um pouco menos e oferece mais opções de cores, mas o valor extra pelo alumínio em um projeto típico é apenas $150–$400.</>,
        ...
        introP: "Quando visitamos uma casa em Orlando, a pergunta mais comum é: \"Devo usar alumínio ou vinil?\" Não há uma resposta universal: depende do seu orçamento, orientação da casa e quanto tempo planeja ficar. Aqui está o que cada material realmente faz:",
        ...
        comparison: [
            { category: "Custo (instalado)", aluminum: "Um pouco mais alto", vinyl: "Um pouco mais baixo", winner: "vinyl" },
            { category: "Vida útil (Flórida)", aluminum: "20–30 anos", vinyl: "15–20 anos", winner: "aluminum" },
            { category: "Resistência a furacões", aluminum: "Excelente, classificado para furacões", vinyl: "Boa, adequado para a maioria das tempestades", winner: "aluminum" },
            { category: "Tolerância ao calor", aluminum: "Não deforma", vinyl: "Pode deformar acima de 60°C", winner: "aluminum" },
            { category: "Resistência ao fogo", aluminum: "Não combustível", vinyl: "Combustível", winner: "aluminum" },
            { category: "Resistência à umidade", aluminum: "100%, não apodrece", vinyl: "100%, não apodrece", winner: "tie" },
            { category: "Resistência a pragas", aluminum: "Difícil de penetrar", vinyl: "Pode ser roído", winner: "aluminum" },
            { category: "Opções de cor", aluminum: "10 cores disponíveis", vinyl: "Maior variedade de cores", winner: "vinyl" },
            { category: "Manutenção", aluminum: "Nenhuma necessária", vinyl: "Limpeza ocasional", winner: "aluminum" },
            { category: "Ambiental", aluminum: "100% reciclável", vinyl: "Não reciclável", winner: "aluminum" },
            { category: "Garantia do fabricante", aluminum: "Até 30 anos", vinyl: "10–15 anos típico", winner: "aluminum" },
            { category: "Dificuldade de instalação", aluminum: "Profissional recomendado", vinyl: "Profissional recomendado", winner: "tie" },
        ],
    },
};
                                ...
                                <table className="w-full bg-white text-sm">
                                    <thead>
                                        <tr className="border-b border-gray-200">
                                            <th className="text-left p-4 font-bold text-gray-500 uppercase text-xs tracking-wide w-1/3"></th>
                                            <th className="text-center p-4 font-extrabold text-blue-700 uppercase text-xs tracking-wide w-1/3">Aluminum / Alumínio</th>
                                            <th className="text-center p-4 font-extrabold text-purple-700 uppercase text-xs tracking-wide w-1/3">Vinyl / Vinil</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-gray-100">
                                        {c.comparison.map((row, i) => (
                                            <tr key={i} className="hover:bg-gray-50 transition-colors">
                                                ...
                                                <td className={`p-4 text-center ${row.winner === "vinyl" ? "text-purple-700 font-bold" : "text-gray-600"}`}>
                                                    <span className="flex items-center justify-center gap-2">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <AnimatedSection from="right">
                                <div className="bg-purple-50 rounded-2xl border border-purple-200 p-7">
                                    <h3 className="text-xl font-extrabold text-purple-900 mb-4">{c.vinylTitle}</h3>
                                    <ul className="space-y-3">
                                    ...
                                    <div className="mt-5 pt-5 border-t border-purple-200">
                                        <p className="text-xs font-bold text-purple-700 flex items-start gap-2">
